...
class ApiService
{
    ...
    public function getMovieTypeCount()
    {
        ...
        $sql    = "SELECT tenpo.住所1,SUM(uriage.合計) FROM tenpo LEFT OUTER JOIN uriage ON tenpo.店舗名=uriage.店舗名 GROUP BY tenpo.住所1";
        $params = array();
    ...
    public function getSpots()
    {
        ...
        $sql    = "SELECT tenpo.住所1,COUNT(tenpo.住所1) AS 店舗数 FROM tenpo GROUP BY tenpo.住所1";
        $params = array();
